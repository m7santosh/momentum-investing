...
ETF_SWING_CHEAT_SHEET: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (
        ...
        (
            ...
            "Mid-week: Preview today's picks — Chg% last rebalance → latest daily EOD",
            "Preview follows Unit + Tail (Week tail 1 = last Fri → today)",
            "Rebalance @ latest bar — weekly Top N @ latest Fri (separate checkbox)",
    ...
    (
        ...
        (
            ...
            "Rank Δ — move vs prior bar (prior week when Preview + Week unit)",
